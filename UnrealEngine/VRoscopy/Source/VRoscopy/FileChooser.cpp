...
void UFileChooser::OpenFileDialog(const FString& DialogTitle, const FString& DefaultPath, const FString& FileTypes, TArray<FString>& OutFileNames)
...
void UFileChooser::PrintData(const FString& File)
...
void UFileChooser::OpenFolderDialog(const FString& DialogTitle, const FString& DefaultPath, FString& OutFolder)
